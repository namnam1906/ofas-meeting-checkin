...
- **สแกนกล้อง** — เล็งกล้องไปที่ QR บนบัตร ระบบเช็คอินให้อัตโนมัติ
...
ทุกอุปกรณ์ที่เปิดหน้านี้พร้อมกันจะเห็นข้อมูลเช็คอินอัปเดตให้กันเองอัตโนมัติ (เปิดเช็คอินได้พร้อมกันหลายจุดหลายเครื่อง) มีสถิติสรุปทั้งหมด/เช็คอินแล้ว/คงเหลือ, log รายการเช็คอินล่าสุด, ปุ่มดาวน์โหลดรายงานเช็คอินเป็นไฟล์ CSV เปิดใน Excel ได้ และปุ่มล้างข้อมูลทั้งหมดไว้เริ่มงานใหม่
...
รูปแบบข้อมูลใน KV:
- คีย์ `roster` → JSON array ของผู้ลงทะเบียนทั้งหมด
- คีย์ `checkin:<id>` → timestamp ISO string ของแต่ละคนที่เช็คอินแล้ว
...
- ออกบัตร QR แบบพิมพ์ได้ (คำนำหน้าชื่อ, ชื่อ-นามสกุล, ตำแหน่ง, สังกัด/หน่วยงาน, รหัส QR) พร้อมปุ่มแชร์/ดาวน์โหลดรูป QR ต่อคน และเลือกพิมพ์/ส่งอีเมล/ลบเฉพาะบางรายการได้
